...
public class SongArrayAdapter extends ArrayAdapter<Song> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (song != null) {
            int defaultImage = this.context.getResources().getIdentifier(song.getImage(),null, this.context.getPackageName());
            ...
            imageLoader.displayImage(song.getImage(),imageView,options);
            TextView tvName = convertView.findViewById(R.id.name);
            tvName.setText(song.getName());
            TextView tvDesc = convertView.findViewById(R.id.desc);
            if (song.isThe())
                tvDesc.setText("The "+song.getArtist());
            else
